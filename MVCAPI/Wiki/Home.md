# 🦶 Barefoot API: Mastering Web API (MVC controller-based)s in .NET 9

Welcome to the **Barefoot API** course! This guide will take you step-by-step from zero to a professional, production-ready Web API (MVC controller-based) using clean architecture principles.
...
| **[Module 2: The First Steps](module_02.md)** | **Static Data & Basic Controllers** | Working with in-memory data, parameter binding, and customizing Swagger documentation. |
